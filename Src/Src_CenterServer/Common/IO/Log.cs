...
namespace GrandChase.IO
{
    public static class Log
    {
        ...
        public static void Connection(string label, bool connection)
        {
            //Log.WriteItem(connection ? "Connect" : "Disconnect", connection ? ConsoleColor.DarkGreen : ConsoleColor.DarkRed, (connection ? "Accepted" : "Lost") + " connection from {0}.", label);
        }
